	...
	public void aendernMaske() {
		...
		speichernAnlegenButton.addClickHandler(new ClickHandler() {
			public void onClick(ClickEvent event) {
				...
				shownLecturer.setLastname(nameTextBox.getText());
				
				verwaltung.aendernLecturer(shownLecturer, new AsyncCallback<Teacher>() {
					public void onFailure(Throwable caught) {
						Window.alert(caught.getMessage());

						verwaltung.auslesenLecturer(shownLecturer, new AsyncCallback<Vector<Teacher>>() {
							public void onFailure(Throwable caught) {
	...
	public void anlegenMaske() {
		...
		speichernAnlegenButton.addClickHandler(new ClickHandler() {
			public void onClick(ClickEvent event) {
				...
				verwaltung.anlegenLecturer(userTextBox.getText(), passwortTextBox.getText(), firstnameTextBox.getText(), nameTextBox.getText(), new AsyncCallback<Teacher>() {
					public void onFailure(Throwable caught) {
						Window.alert(caught.getMessage());
						speichernAnlegenButton.setEnabled(true);
					}
