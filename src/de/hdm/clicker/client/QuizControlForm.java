				...
				if(!q.isAutomatic() && !q.isStarted()) {
					...
					startButton.addClickHandler(new ClickHandler() {
						public void onClick(ClickEvent event) {
							...
							quizVector.elementAt(rowIndex).setStartingTime((new Integer(DateTimeFormat.getFormat("HH").format(new Date()))*60) + (new Integer(DateTimeFormat.getFormat("mm").format(new Date()))));
