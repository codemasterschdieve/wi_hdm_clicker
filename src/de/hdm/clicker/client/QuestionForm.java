...
public class QuestionForm extends VerticalPanel {
	...
	public void fillForm() {
		...
		this.answer1TextArea.setText(this.shownQuestion.getAnswer1Text());
	...
	public void aendernMaske() {
		...
		speichernAnlegenButton.addClickHandler(new ClickHandler() {
			public void onClick(ClickEvent event) {
				...
				shownQuestion.setQuestionText(questionTextArea.getText());
				shownQuestion.setAnswer1Text(answer1TextArea.getText());
				shownQuestion.setAnswer2Text(answer2TextArea.getText());
