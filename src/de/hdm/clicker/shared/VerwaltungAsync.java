...
public interface VerwaltungAsync {
	...
	void auslesenAlleLecturer(AsyncCallback<Vector<Teacher>> callback) throws RuntimeException;
	
	void auslesenLecturer(Teacher lecturer, AsyncCallback<Vector<Teacher>> callback) throws RuntimeException;
	
	void aendernLecturer(Teacher lecturer, AsyncCallback<Teacher> callback) throws RuntimeException;
	
	void loeschenLecturer(Teacher lecturer, AsyncCallback<Void> callback) throws RuntimeException;
	
	void anlegenLecturer(String user, String password, String firstName, String name, AsyncCallback<Teacher> callback) throws RuntimeException;
	...
	void getSignedLecturer(AsyncCallback<Teacher> callback) throws RuntimeException;
	...
	void auslesenChartInfoByQuiz(Quiz quiz, AsyncCallback<Vector<InfoGraph>> callback) throws RuntimeException;
	...
	void erfassenResult(Result result, AsyncCallback<Boolean> callback) throws RuntimeException;
	
	void erfassenfehlenderResult(Vector<Result> vr, AsyncCallback<Vector<Boolean>> callback) throws RuntimeException;
